                    ...
                    <div class="col-md-3">
                        <div class="card card-success card-outline">
                            <div class="card-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    ...
                                    <li class="list-group-item">
                                        <b class="ColorText">Documento ID</b><a class="text-muted float-right">123456789</a>
                                    </li>
                                    <li class="list-group-item">
                                        <b class="ColorText">Usuario</b><a class="text-muted float-right">Diego123</a>
                                    </li>
                                    <li class="list-group-item">
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">3175914679</p>

                                <strong class="ColorText">
                                    <i class="fas fa-map-marker-alt">Ubicacion</i>
                                </strong>
                                <p class="text-muted">Calle32#26.09</p>
                                ...
                                <p class="text-muted">diego.salgado.7720@eam.edu.co</p>
